...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionOpen_File_2->setObjectName("actionOpen_File_2");
        ...
        gridLayout->addWidget(tableView_2, 8, 0, 1, 3);
        ...
        sizePolicy1.setHeightForWidth(dateLine->sizePolicy().hasHeightForWidth());
        dateLine->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(operatorLine->sizePolicy().hasHeightForWidth());
        operatorLine->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(orderLine->sizePolicy().hasHeightForWidth());
        orderLine->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(deliveryLine->sizePolicy().hasHeightForWidth());
        deliveryLine->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(deliveryposLine->sizePolicy().hasHeightForWidth());
        deliveryposLine->setSizePolicy(sizePolicy1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionOpen_File_2->setText(QCoreApplication::translate("MainWindow", "Open File", nullptr));
